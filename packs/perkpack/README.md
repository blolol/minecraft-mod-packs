...
Perkpack is Blolol's flavor-of-the-month Minecraft mod pack, used on our private Minecraft server. It doesn't follow any particular theme, and is a reflection of the community's whims. Sometimes we might be interested in a minimalist "vanilla plus" experience, then ruthlessly strip-mining every dimension to oblivion using advanced technology, and the next world might be a hardcore survival challenge.
